                ...
                <div class="droite2">
                    <div class="filtre">
                        ...
                        <select name="escape">
                            ...
                            <?php foreach ($escapes as $e): ?>
                                <option value="<?= $e['id_escape'] ?>" <?= ($escapeSelected == $e['id_escape']) ? 'selected' : '' ?>>
                                    <?= $e['nom'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="joursj">
                        <div class="datejours">
                            ...
                            <span id="#">
                                <!-- Permet d'afficher la date du jour en francais -->
                                <?php
                                $date = new DateTime();
