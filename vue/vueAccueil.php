...
<section class="accueil-section accueil-escapes">
    <div class="accueil-conteneur">
    ...
    <div class="accueil-conteneur">
        ...
        <div class="accueil-avis__grille">
            <article class="accueil-avis-card">
                ...
                <p class="accueil-avis-card__texte">Hopla vous savez que la mamsell Huguette, la miss Miss Dahlias du
                    messti de Bischheim était au Christkindelsmärk</p>
