        ...
        <div class="menu-categorie">
            ...
            <a href="index.php?action=utilisateurs" class="user">
                <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M13.6 17.2V15.4C13.6 14.4453 13.2207 13.5296 12.5456 12.8545C11.8705 12.1793 10.9548 11.8 10 11.8H4.6C3.64522 11.8 2.72955 12.1793 2.05442 12.8545C1.37928 13.5296 1 14.4453 1 15.4V17.2M13.6 1.11523C14.372 1.31537 15.0557 1.76617 15.5437 2.39689C16.0318 3.02761 16.2966 3.80253 16.2966 4.60003C16.2966 5.39753 16.0318 6.17246 15.5437 6.80318C15.0557 7.4339 14.372 7.8847 13.6 8.08483M19 17.2V15.4C18.9994 14.6024 18.7339 13.8275 18.2452 13.1971C17.7565 12.5667 17.0723 12.1164 16.3 11.917"
                        stroke="#F2F2F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path
                        d="M7.3002 8.2C9.28842 8.2 10.9002 6.58822 10.9002 4.6C10.9002 2.61177 9.28842 1 7.3002 1C5.31197 1 3.7002 2.61177 3.7002 4.6C3.7002 6.58822 5.31197 8.2 7.3002 8.2Z"
                        stroke="#F2F2F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="case">
                                        ...
                                        <div class="duree"><?= $escape['duree'] ?> min</div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <a class="modif" href="index.php?action=modifierEscape&id=<?= $escape['id_escape'] ?>">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M14.8371 6.61186L15.5787 5.87025C16.1686 5.2803 16.5 4.48014 16.5 3.64582C16.5 2.8115 16.1686 2.01135 15.5787 1.42139C14.9887 0.831434 14.1886 0.5 13.3543 0.5C12.5201 0.5 11.7199 0.831434 11.13 1.42139L10.3884 2.163L3.57109 8.9791C3.1095 9.4415 2.87831 9.67271 2.67992 9.92711C2.44584 10.2275 2.24495 10.5523 2.08074 10.8959C1.94234 11.1871 1.83915 11.4975 1.63276 12.1167L0.757587 14.7416M14.8371 6.61186C14.8371 6.61186 13.2619 6.51906 11.8716 5.12864C10.4812 3.73902 10.3892 2.163 10.3892 2.163M14.8371 6.61186L8.02053 13.428C7.55894 13.8896 7.32775 14.1208 7.07336 14.3192C6.77299 14.5533 6.44818 14.7542 6.1046 14.9184C5.81341 15.0568 5.50382 15.16 4.88384 15.3664L2.25913 16.2416M2.25913 16.2416L1.61756 16.456C1.468 16.5062 1.30743 16.5136 1.15388 16.4775C1.00033 16.4414 0.8599 16.3632 0.748365 16.2516C0.636829 16.1401 0.558614 15.9996 0.522511 15.8461C0.486408 15.6925 0.493848 15.5319 0.543995 15.3824L0.758387 14.7408L2.25913 16.2416Z"
                                                stroke="#F2F2F2" />
                                        </svg>
                                    </a>
        ...
        <div class="popup-content">
            ...
            <span class="close" id="closePopup">
                <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1.5 17.5L17.5 1.5M1.5 1.5L17.5 17.5" stroke="#C5A059" stroke-width="3"
            ...
            <div class="ajout">
                ...
                <form method="post" enctype="multipart/form-data"
                    action="<?= $_SERVER["PHP_SELF"] . "?action=ajoutEscape" ?>">
                    <div>
                    ...
                    <div>
                        <label>
                            ...
                            <input type="text" name="nom" value="" id="inputnomEscape" placeholder="Nom de l'escape"
                                required>
                        </label>
                        ...
                        <label class="image-label">
                            ...
                            <input type="file" name="photoEscape"
                        ...
                        <label>
                            ...
                            <input type="text" name="description" value="" id="inputdescription"
                                placeholder="Description de l'escape" required>
                        </label>
                        <label>
                            <span id="lieuNvEscape">Lieu</span>
                            <input type="text" name="lieu" value="" id="inputlieu" placeholder="Lieu de l'escape"
                                required>
                        </label>
                        <label>
                            <span id="dureeNvEscape">Durée (en min)</span>
                            <input type="number" name="duree" value="" id="inputduree" placeholder="Durée de l'escape"
                                required>
                        </label>
                        <label>
                            <span id="prsnMin">Nb de pers min</span>
                            <input type="number" name="pers_min" value="" id="inputpersmin"
                                placeholder="Nombre de personnes min" required>
                        </label>
                        <label>
                            <span id="prsnMax">Nb de pers max</span>
                            <input type="number" name="pers_max" value="" id="inputpersmax"
                                placeholder="Nombre de personnes max" required>
                        </label>
                    </div>
                    <div>
